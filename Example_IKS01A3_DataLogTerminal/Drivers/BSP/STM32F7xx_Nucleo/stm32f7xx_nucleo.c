...
/** @defgroup STM32F7XX_NUCLEO STM32F7XX_NUCLEO
 * @{
 */

/** @defgroup STM32F7XX_NUCLEO_LOW_LEVEL STM32F7XX_NUCLEO LOW LEVEL
...
/** @defgroup STM32F7XX_NUCLEO_LOW_LEVEL_Private_Defines STM32F7XX_NUCLEO LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STM32F7XX_NUCLEO_LOW_LEVEL_FunctionPrototypes STM32F7XX_NUCLEO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32F7XX_NUCLEO_LOW_LEVEL_Private_Variables STM32F7XX_NUCLEO LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__STM32F7XX_NUCLEO_BSP_VERSION;
}
